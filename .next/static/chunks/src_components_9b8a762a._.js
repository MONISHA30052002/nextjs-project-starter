...
"[project]/src/components/skincare/SkinQuizForm.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>SkinQuizForm)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-hook-form/dist/index.esm.mjs [app-client] (ecmascript)");
...
;
;
const quizSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"])({
    oiliness: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"])().min(1, "Please select an option"),
    poreSize: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"])().min(1, "Please select an option"),
    sensitivity: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"])().min(1, "Please select an option"),
    breakouts: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"])().min(1, "Please select an option"),
    skinFeel: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"])().min(1, "Please select an option"),
    weatherReaction: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"])().min(1, "Please select an option")
});
const questions = [
    {
        id: 'oiliness',
        title: 'How does your skin feel by midday?',
        description: 'Think about how your skin typically feels after a few hours without touching it.',
        options: [
            {
                value: 'very-oily',
                label: 'Very oily and shiny all over',
                description: 'Noticeable shine on forehead, nose, cheeks, and chin'
            },
            {
                value: 'oily-tzone',
                label: 'Oily in T-zone only',
                description: 'Shine mainly on forehead, nose, and chin'
            },
            {
                value: 'balanced',
                label: 'Comfortable and balanced',
                description: 'No excessive oil or dryness'
            },
            {
                value: 'tight-dry',
                label: 'Tight and dry',
                description: 'Feels stretched or uncomfortable'
            }
        ]
    },
    {
        ...
        description: 'Look closely at your skin in natural light.',
        options: [
            {
                value: 'large-visible',
                label: 'Large and easily visible',
                description: 'Especially noticeable on nose and cheeks'
            },
            {
                value: 'medium-tzone',
                label: 'Medium-sized in T-zone',
                description: 'More visible on forehead, nose, and chin'
            },
            {
                value: 'small-fine',
                label: 'Small and fine',
                description: 'Barely noticeable across the face'
            },
            {
                value: 'barely-visible',
                label: 'Barely visible',
                description: 'Very fine texture overall'
            }
        ]
    },
    {
        ...
        description: 'Consider your typical experience when trying new skincare items.',
        options: [
            {
                value: 'very-reactive',
                label: 'Very reactive',
                description: 'Often gets red, itchy, or irritated'
            },
            {
                value: 'somewhat-sensitive',
                label: 'Somewhat sensitive',
                description: 'Occasional mild reactions'
            },
            {
                value: 'generally-tolerant',
                label: 'Generally tolerant',
                description: 'Rare reactions to most products'
            },
            {
                value: 'very-tolerant',
                label: 'Very tolerant',
                description: 'Almost never reacts negatively'
            }
        ]
    },
    {
        ...
        description: 'Think about your typical skin condition over the past few months.',
        options: [
            {
                value: 'frequent',
                label: 'Frequently',
                description: 'Multiple breakouts most of the time'
            },
            {
                value: 'occasional',
                label: 'Occasionally',
                description: 'A few breakouts here and there'
            },
            {
                value: 'rarely',
                label: 'Rarely',
                description: 'Very infrequent breakouts'
            },
            {
                value: 'never',
                label: 'Almost never',
                description: 'Clear skin most of the time'
            }
        ]
    },
    {
        id: 'skinFeel',
        title: 'After cleansing, how does your skin feel?',
        description: 'Consider the immediate feeling after washing your face with a gentle cleanser.',
        options: [
            {
                value: 'tight-uncomfortable',
                label: 'Tight and uncomfortable',
                description: 'Feels stretched and needs immediate moisturizer'
            },
            {
                value: 'slightly-tight',
                label: 'Slightly tight',
                description: 'Mildly uncomfortable but manageable'
            },
            {
                value: 'comfortable',
                label: 'Comfortable',
                description: 'Feels clean and balanced'
            },
            {
                value: 'still-oily',
                label: 'Still feels oily',
                description: 'Not completely clean, some oil remains'
            }
        ]
    },
    {
        ...
        description: 'Think about seasonal changes and different climates.',
        options: [
            {
                value: 'dry-winter',
                label: 'Gets very dry in winter',
                description: 'Needs extra moisture in cold weather'
            },
            {
                value: 'oily-summer',
                label: 'Gets very oily in summer',
                description: 'Becomes shinier in hot, humid weather'
            },
            {
                value: 'varies-season',
                label: 'Changes with seasons',
                description: 'Different needs throughout the year'
            },
            {
                value: 'stays-same',
                label: 'Stays fairly consistent',
                description: 'Weather doesn\'t significantly affect it'
            }
        ]
    }
];
function SkinQuizForm() {
    _s();
    const [currentStep, setCurrentStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [result, setResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const form = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
        resolver: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$hookform$2f$resolvers$2f$zod$2f$dist$2f$zod$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodResolver"])(quizSchema)
    });
    const progress = (currentStep + 1) / questions.length * 100;
    const onSubmit = (data)=>{
        // Simple skin type determination logic
        const answers = Object.values(data);
        const oilyCount = answers.filter((answer)=>answer.includes('oily') || answer === 'large-visible' || answer === 'still-oily').length;
        const dryCount = answers.filter((answer)=>answer.includes('dry') || answer.includes('tight') || answer === 'barely-visible').length;
        const sensitiveCount = answers.filter((answer)=>answer.includes('reactive') || answer.includes('sensitive')).length;
        let skinType = 'Normal';
        let description = 'Your skin appears to be well-balanced with minimal concerns.';
        let recommendations = [
            'Use a gentle cleanser twice daily',
            'Apply a lightweight moisturizer',
            'Don\'t forget daily SPF protection',
            'Consider a weekly gentle exfoliant'
        ];
        if (oilyCount >= 3) {
            skinType = 'Oily';
            description = 'Your skin produces excess oil, especially in the T-zone area.';
            recommendations = [
                'Use a foaming or gel-based cleanser',
                'Look for oil-free, non-comedogenic moisturizers',
                'Consider salicylic acid for pore care',
                'Use clay masks 1-2 times per week'
            ];
        } else if (dryCount >= 3) {
            skinType = 'Dry';
            description = 'Your skin lacks moisture and may feel tight or uncomfortable.';
            recommendations = [
                'Use a creamy, hydrating cleanser',
                'Apply a rich moisturizer twice daily',
                'Look for ingredients like hyaluronic acid',
                'Avoid harsh scrubs and over-cleansing'
            ];
        } else if (sensitiveCount >= 2) {
            skinType = 'Sensitive';
            description = 'Your skin is reactive and needs gentle, fragrance-free products.';
            recommendations = [
                'Choose fragrance-free, hypoallergenic products',
                'Patch test new products before full use',
                'Look for soothing ingredients like aloe vera',
                'Avoid harsh actives and strong fragrances'
            ];
        } else if (oilyCount >= 1 && dryCount >= 1) {
            skinType = 'Combination';
            description = 'Your skin has both oily and dry areas, typically oily T-zone with drier cheeks.';
            recommendations = [
        ...
        setResult(`${skinType}|${description}|${recommendations.join('|')}`);
    };
    const nextStep = ()=>{
    ...
    if (result) {
        const [skinType, description, ...recommendations] = result.split('|');
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    fileName: "[project]/src/components/skincare/SkinQuizForm.tsx",
                                    lineNumber: 188,
                                    columnNumber: 29
                                }, this)
                            ]
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    className: "bg-gradient-to-r from-rose-50 to-blue-50",
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                ...
                                children: recommendations.map((rec, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "text-rose-500 mr-2 mt-1",
                                                children: "•"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/skincare/SkinQuizForm.tsx",
                                                lineNumber: 203,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            onClick: ()=>window.location.href = '/routine-builder',
                            className: "bg-rose-500 hover:bg-rose-600 text-white",
                            children: "Build My Routine"
                        }, void 0, false, {
                            fileName: "[project]/src/components/skincare/SkinQuizForm.tsx",
                            lineNumber: 223,
                            columnNumber: 11
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        currentStep === questions.length - 1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            type: "submit",
                            className: "bg-rose-500 hover:bg-rose-600 text-white",
                            disabled: !form.watch(currentQuestion.id),
                            children: "Get My Results"
                        }, void 0, false, {
                            fileName: "[project]/src/components/skincare/SkinQuizForm.tsx",
                            lineNumber: 305,
                            columnNumber: 13
...
_s(SkinQuizForm, "hA0KiqEBEE8hg1u973KaaTRkj+M=", false, function() {
    return [
...
_c = SkinQuizForm;
var _c;
__turbopack_context__.k.register(_c, "SkinQuizForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_components_9b8a762a._.js.map